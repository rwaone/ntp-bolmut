    ...
    <div class="modal-dialog relative w-auto pointer-events-none">
        <div
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <form id="form-create" action="{{ route('groups.store') }}" method="post">
                    <!-- Modal body -->
                    <div class="p-6 space-y-4">
                        @csrf
                        <div class="label-area mb-3">
                            <label for="section_id" class="form-label">Bagian</label>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                ...
                <form id="form-update" action="" method="post">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="label-area mb-3">
                            <label for="update_section_id" class="form-label">Bagian</label>
                            <select id="update_section_id" name="section_id" class="form-control select2">
                                <option disabled selected>-- Pilih Bagian --</option>
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}">{{ $section->name }}</option>
                                @endforeach
